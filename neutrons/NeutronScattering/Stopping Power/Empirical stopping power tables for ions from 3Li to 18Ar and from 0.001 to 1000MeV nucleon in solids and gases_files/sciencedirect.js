...
jQuery.fn.on2=function(eventType,filter,data,handler) {
	...
	if(filter) {
		$(this).on(eventType,filter,data,function(e) {
			if(!$(e.target).is(elements)) handler(e);
		});
	}
}
...
this.s_eventHandlers=new function() {
	...
	this.contentViewClick=function(e) {
		...
		s.pageURL=e.target.href;
		s.channel="publications";
		s.pageName="article";
		s.products=";"+getPii(e.target.href);
		s.eVar17=e.data;
	...
	this.refineResultsSearchSubmit=function(e) {
		...
		var getNav=function() {
			var su=[];
			jQuery("#navBox li[id]:has(input:checked)").each(function(i,e) {
		...
		case "navExclude":
			...
			break;
		case "SISRSearch":
			s.eVar12="Search Within Results";
			s.linkTrackVars="events,eVar12";
			break;
		default: return true;
		}
	
		s.getPreviousValue('Explicit','gpv_e2','event3');
		s.events="event6";
...
$(document).on2("click","a[href],[onclick],input,button",null,s_eventHandlers.basicClick);
...
{x:{h:["sdpts.sciencedirect.com"],p:["/cartBillingAddress.do"]},
p:[{t:'c',c:'s.channel="Home";\ns.pageName="SDPTS Payment Info";\ns.prop1="Home";\ns.prop2=s.prop1;\ns.prop4="Shopping Cart";'}]},
{x:{h:["sdpts.sciencedirect.com"],p:["/cartPaymentData.do"]},
p:[{t:'c',c:'s.channel="Home";\ns.pageName="SDPTS Confirm";\ns.prop1="Home";\ns.prop2=s.prop1;\ns.prop4="Shopping Cart";'}]},
{x:{h:["sdpts.sciencedirect.com"],p:["/cartConfirm.do"]},
p:[{t:'c',c:'s.channel="Home";\ns.pageName="SDPTS Receipt";\ns.prop1="Home";\ns.prop2=s.prop1;\ns.prop4="Shopping Cart";'}]},
{x:{h:["sdpts.sciencedirect.com"],p:["/CartBillingAddress.jsp"]},
p:[{t:'c',c:'s.channel="Home";\ns.pageName="SDPTS AddressInfo Reload";\ns.prop1="Home";\ns.prop2=s.prop1;\ns.prop4="Shopping Cart";'}]},
{x:{h:["sdpts.sciencedirect.com"],p:["/CartPaymentData.jsp"]},
p:[{t:'c',c:'s.channel="Home";\ns.pageName="SDPTS Payment Info Reload";\ns.prop1="Home";\ns.prop2=s.prop1;\ns.prop4="Shopping Cart";'}]},
